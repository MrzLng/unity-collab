...
public class EggPath : MonoBehaviour
{
    ...
    Dictionary<Vector3, List<Tuple<Vector3, float>>> possible =
		new Dictionary<Vector3, List<Tuple<Vector3, float>>>() {
            ...
            { new Vector3( -31f,    1f, 71f), new List<Tuple<Vector3, float>>(){ new Tuple<Vector3, float>(new Vector3(-45f, 1f, 71f), 0.95f), new Tuple<Vector3, float>(new Vector3(-31f, 1f, 74f), 1f) }},
            { new Vector3( -45f,    1f, 71f), new List<Tuple<Vector3, float>>(){ new Tuple<Vector3, float>(new Vector3(-184.5f, 1f, 71f), 1f) }},

...
public class videocamera : MonoBehaviour
{
    ...
    private Vector3 currentheight = new Vector3(0f, 60f, 0f);
    ...
    void Update()
    {
        ...
        if (zooming) { currentheight = Vector3.Lerp(currentheight, new Vector3(0f, 30f, 0f), percentage); percentage += 0.2f * Time.deltaTime; }
